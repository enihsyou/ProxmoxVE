...
ADDON_SCRIPT="https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/coolify.sh)"
MIGRATION_EOF
