...
ADDON_SCRIPT="https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/dokploy.sh)"
MIGRATION_EOF
