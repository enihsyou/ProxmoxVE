...
ADDON_SCRIPT="https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/dockge.sh)"
MIGRATION_EOF
