...
ADDON_SCRIPT="https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/komodo.sh)"
MIGRATION_EOF
