...
ADDON_SCRIPT="https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/addon/runtipi.sh)"
MIGRATION_EOF
