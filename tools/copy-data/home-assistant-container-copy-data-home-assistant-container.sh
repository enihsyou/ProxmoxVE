...
# Use to copy all data from one Home Assistant LXC to another
# run from the Proxmox Shell
# bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scriptsmain/tools/copy-data//home-assistant-container-copy-data-home-assistant-container.sh)"
