...
#
# bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://pve-files.enihsyou.synology.me/helper-scripts"
