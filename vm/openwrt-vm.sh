...
source /dev/stdin <<<$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/misc/api.func)
...
URL="https://mirrors.cernet.edu.cn/openwrt/releases/$stableversion/targets/x86/64/openwrt-$stableversion-x86-64-generic-ext4-combined.img.gz"
...
<div align='center'>
  <a href='https://community-scripts.org' target='_blank' rel='noopener noreferrer'>
    <img src='https://pve-files.enihsyou.synology.me/helper-scripts/misc/images/logo-81x112.png' alt='Logo' style='width:81px;height:112px;'/>
  </a>
