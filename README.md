<div align="center">
  <img src="https://pve-files.enihsyou.synology.me/helper-scripts/misc/images/logo-81x112.png" height="120px" alt="Proxmox VE Helper-Scripts Logo" />
...
```bash
bash -c "$(curl -fsSL https://pve-files.enihsyou.synology.me/helper-scripts/ct/pve-scripts-local.sh)"
```
